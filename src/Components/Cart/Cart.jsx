            ...
            {(cart.data.products).map((product,index) =><>
              <tr key={index} className="bg-[#b3b3b3] md:border-b cursor-pointer border-[#1a1a1a] hover:bg-[#8c8c8c] duration-300" >
                  ...
                  <td className="px-6 py-4">
                      <div onClick={()=>deleteProduct(product.product.id)} className="cursor-pointer font-medium text-red-600  hover:underline">Remove</div>
                  </td>
              </tr> 
              <tr>
                <td colSpan={4} className='md:hidden border-none'>              
