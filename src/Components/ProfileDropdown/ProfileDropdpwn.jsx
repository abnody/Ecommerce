  ...
  return <>
    ...
    <div className='absolute -inset-x-16 w-36 mt-2 text-center px-2 py-3 text-gray-400 bg-secondary rounded-2xl '> 
        ...
        <div>
            ...
            <p className='py-1 cursor-pointer hover:text-main duration-150 border-b pb-4 border-gray-400' onClick={()=>logout()} >Logout</p>
            <NavLink to={'/updatepassword'} className='block py-1 cursor-pointer hover:text-main duration-150 ' >Update Password</NavLink>
