  ...
  return (
    <div className="relative w-full py-16">
      ...
      <div className="relative">
        ...
        <ul ref={sliderRef} className="bg-[#b3b3b3] flex rounded-xl mb-10 overflow-x-scroll scrollbar-hide">
          {categories.map((cat) => (
            <div key={cat._id} onClick={() => dispalyProducts(cat._id)} className={`py-3 cursor-pointer flex-shrink hover:bg-[#3f3f3f] group duration-300 ${cat._id === selectedCategoryId ? 'clicked' : ''}`}>
            ...
            <div className="product hover:shadow-black hover:shadow-xl bg-[#3f3f3f] rounded-lg relative">
              ...
              <Link to={`/productdetails/${product.id}`} className="block">
                ...
                <div className="px-1 py-3 text-center">
                  <h2 className="mb-2 text-lg font-bold tracking-tight text-main">{product.slug.split('-', 2).join(' ')}</h2>
