...
export default function ProductDetails() {
  ...
  return <>
    <Helmet>
        ...
        <meta name='keywords' content={`${product?.category}, ${product?.brand}, onlineShopping`} />
        <title>{product?.title.split(" ",10).join(" ")}</title>
    </Helmet>

    {isLoading?<Loading/>:
        <div className=' my-10 lg:flex items-center'>
            <div className='lg:w-2/5 lg:mx-0 mx-auto max-w-512 px-12'>
